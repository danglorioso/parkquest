...
import { getAdminReports, actOnReport, getAdminStats, type AdminStats } from '@/lib/api';
        ...
        ListHeaderComponent={
          stats ? (
            <View style={st.statsRow}>
              ...
              <StatPill label="Posts" value={stats.total_posts} />
              <StatPill label="Active 7d" value={stats.active_users_7d} />
            </View>
          ) : null
        }
        ListEmptyComponent={
...
const st = StyleSheet.create({
  ...
  statPill: {
    ...
    borderWidth: 0.5, borderColor: C.hairline, padding: 12, alignItems: 'center',
  },
  statValue: { fontSize: 18, fontWeight: '800', color: C.ink },
  statLabel: { fontSize: 11, color: C.inkMute, marginTop: 2 },
  card: {
